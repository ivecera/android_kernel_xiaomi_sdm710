...
#define TAS2562_REG(page, reg)	(((page) << 7) | reg)

/* Page Control Register */
#define TAS2562_PAGE_CTRL	TAS2562_REG(0x0, 0x00)

/* Book Control Register (available in page0 of each book) */
#define TAS2562_BOOK_CTRL	TAS2562_REG(0x0, 0x7f)

#define TAS2562_PAGE_ID(reg)	((reg % (256 * 128)) / 128)
#define TAS2562_PAGE_REG(reg)	((reg % (256 * 128)) % 128)

/* Software Reset */
#define TAS2562_SW_RESET	TAS2562_REG(0x0, 0x01)
#define TAS2562_RESET		BIT(0)

/* Power Control */
#define TAS2562_PWR_CTL		TAS2562_REG(0x0, 0x02)
...
#define TAS2562_PB_CFG1		TAS2562_REG(0x0, 0x03)

/* Misc Configuration 1 */
#define TAS2562_MISC_CFG1	TAS2562_REG(0x0, 0x04)
#define TAS2562_IRQZ_PU		BIT(3)

/* TDM Configuration 0 */
#define TAS2562_TDM_CFG0	TAS2562_REG(0x0, 0x06)
...
/* TDM Configuration 1 */
#define TAS2562_TDM_CFG1	TAS2562_REG(0x0, 0x07)
...
/* TDM Configuration 2 */
#define TAS2562_TDM_CFG2	TAS2562_REG(0x0, 0x08)
...
/* TDM Configuration 4 */
#define TAS2562_TDM_CFG4	TAS2562_REG(0x0, 0x0A)
...
#define TAS2562_LIM_CFG0	TAS2562_REG(0x0, 0x12)

/* Interrupt Mask 0 */
#define TAS2562_INT_MASK0	TAS2562_REG(0x0, 0x1A)
...
/* Interrupt Mask 1 */
#define TAS2562_INT_MASK1	TAS2562_REG(0x0, 0x1B)
...
#define TAS2562_INT_LTCH0	TAS2562_REG(0x0, 0x24)
...
#define TAS2562_INT_LTCH1	TAS2562_REG(0x0, 0x25)
...
#define TAS2562_INT_LTCH2	TAS2562_REG(0x0, 0x28)
#define TAS2562_INT_LTCH3	TAS2562_REG(0x0, 0x26)
#define TAS2562_INT_LTCH4	TAS2562_REG(0x0, 0x27)
...
#define TAS2562_INT_CLK		TAS2562_REG(0x0, 0x30)
#define TAS2562_INT_CLR_LTCH	BIT(2)

/* Boost Configure 3 */
#define TAS2562_BOOST_CFG3	TAS2562_REG(0x0, 0x35)

/* Clock Configuration */
#define TAS2562_CLK_CFG		TAS2562_REG(0x0, 0x38)

#define TAS2562_VBAT_FLT	TAS2562_REG(0x0, 0x3b)
#define TAS2562_CLS_H_RTMR	TAS2562_REG(0x0, 0x3c)

#define TAS2562_IDC_CFG0	TAS2562_REG(0x2, 0x64)
#define TAS2562_IDC_CFG1	TAS2562_REG(0x2, 0x65)
#define TAS2562_IDC_CFG2	TAS2562_REG(0x2, 0x66)
#define TAS2562_IDC_CFG3	TAS2562_REG(0x2, 0x67)

#define TAS2562_TEST_PG_CFG	TAS2562_REG(0xfd, 0xd)
#define TAS2562_CLS_D_CFG1	TAS2562_REG(0xfd, 0x19)
#define TAS2562_CLS_D_CFG2	TAS2562_REG(0xfd, 0x32)
#define TAS2562_CLS_D_CFG3	TAS2562_REG(0xfd, 0x33)
#define TAS2562_CLS_D_CFG4	TAS2562_REG(0xfd, 0x3f)
#define TAS2562_EFFC_CFG	TAS2562_REG(0xfd, 0x5f)

#define TAS2562_DEF_BOOK_ID	0x00
#define TAS2562_CLS_H_BOOK_ID	0x64

#define TAS2562_CLS_H_HDRM_CFG0	TAS2562_REG(0x7, 0x48)
#define TAS2562_CLS_H_HDRM_CFG1	TAS2562_REG(0x7, 0x49)
#define TAS2562_CLS_H_HDRM_CFG2	TAS2562_REG(0x7, 0x4a)
#define TAS2562_CLS_H_HDRM_CFG3	TAS2562_REG(0x7, 0x4b)
#define TAS2562_CLS_H_HYST_CFG0	TAS2562_REG(0x7, 0x4c)
#define TAS2562_CLS_H_HYST_CFG1	TAS2562_REG(0x7, 0x4d)
#define TAS2562_CLS_H_HYST_CFG2	TAS2562_REG(0x7, 0x4e)
#define TAS2562_CLS_H_HYST_CFG3	TAS2562_REG(0x7, 0x4f)
#define TAS2562_CLS_H_MTCT_CFG0	TAS2562_REG(0x5, 0x4c)
#define TAS2562_CLS_H_MTCT_CFG1	TAS2562_REG(0x5, 0x4d)
#define TAS2562_CLS_H_MTCT_CFG2	TAS2562_REG(0x5, 0x4e)
#define TAS2562_CLS_H_MTCT_CFG3	TAS2562_REG(0x5, 0x4f)
